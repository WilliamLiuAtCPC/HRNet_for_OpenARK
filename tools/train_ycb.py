...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        #required=True,
                        default="experiments/cityscapes/seg_hrnet_ocr_w48_train_ycb.yaml",
                        type=str)
...
def main():
    ...
    distributed = args.local_rank >= 0 #False # changed #
    ...
    train_dataset = eval('datasets.'+config.DATASET.DATASET)(
                        ...
                        scale_factor=config.TRAIN.SCALE_FACTOR)# changed
    # train_dataset = eval('datasets.'+config.DATASET.DATASET)(mode="train", num_pt=1000, add_noise=True, root="data/ycb/YCB_Video_Dataset", noise_trans=0.005, refine=False)
    ...
    test_dataset = eval('datasets.'+config.DATASET.DATASET)(
                        ...
                        crop_size=test_size,
                        downsample_rate=1)
    # test_dataset = eval('datasets.'+config.DATASET.DATASET)(mode="test", num_pt=1000, add_noise=True, root="data/ycb/YCB_Video_Dataset", noise_trans=0.005, refine=False)
